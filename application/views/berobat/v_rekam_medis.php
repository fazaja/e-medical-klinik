            ...
            <div class="col-md-6">
                <div class="card border-danger">
                    <div class="card-header bg-danger text-white">
                        Catatan (Rekam Medis)
                        <a href="<?= base_url('berobat');?>" class="btn btn-warning btn-sm float-right">Kembali</a>
                    </div>

                    <div class="card-body">
                        <form method="post" action="<?= base_url();?>berobat/insert_rm">
                ...
                <!-- <div class="card border-success mt-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?= base_url('berobat/insert_resep'); ?>">
                            <input type="hidden" name="id" value="<?= $d['id_berobat']; ?>">    
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
